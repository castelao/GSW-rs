...
pub fn kappa(sa: f64, ct: f64, p: f64) -> Result<f64> {
    ...
    let v = V000
        + s * (V100 + s * (V200 + s * (V300 + s * (V400 + s * (V500 + V600 * s)))))
        + tau
            * (V010
                + s * (V110 + s * (V210 + s * (V310 + s * (V410 + V510 * s))))
                + tau
                    * (V020
                        + s * (V120 + s * (V220 + s * (V320 + V420 * s)))
                        + tau
                            * (V030
                                + s * (V130 + s * (V230 + V330 * s))
                                + tau
                                    * (V040
                                        + s * (V140 + V240 * s)
                                        + tau * (V050 + V150 * s + V060 * tau)))))
        + pi * (V001
            + s * (V101 + s * (V201 + s * (V301 + s * (V401 + V501 * s))))
            + tau
                * (V011
                    + s * (V111 + s * (V211 + s * (V311 + V411 * s)))
                    + tau
                        * (V021
                            + s * (V121 + s * (V221 + V321 * s))
                            + tau
                                * (V031
                                    + s * (V131 + V231 * s)
                                    + tau * (V041 + V141 * s + V051 * tau))))
            + pi * (V002
                + s * (V102 + s * (V202 + s * (V302 + V402 * s)))
                + tau
                    * (V012
                        + s * (V112 + s * (V212 + V312 * s))
                        + tau
                            * (V022
                                + s * (V122 + V222 * s)
                                + tau * (V032 + V132 * s + V042 * tau)))
                + pi * (V003
                    + s * (V103 + V203 * s)
                    + tau * (V013 + V113 * s + V023 * tau)
                    + pi * (V004 + V104 * s + V014 * tau + pi * (V005 + V006 * pi)))));
