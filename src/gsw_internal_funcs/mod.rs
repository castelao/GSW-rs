...
pub(crate) fn hill_ratio_at_sp2(t: f64) -> f64 {
    ...
    let t68: f64 = crate::conversions::t68_from_t90(t);
...
mod test_gibbs_ice {
    ...
    fn check_values() {
        ...
        // (nt, np, ans)
        let answers = [
            (0, 0, 98.267_598_402_919_25),
            (1, 0, 1_220.788_661_299_952_8),
            (0, 1, 0.001_090_843_442_926_435),
            (1, 1, 1.743_608_249_608_496_2E-7),
            (2, 0, -9.078_428_407_946_305),
            (0, 2, -1.284_848_246_397_617_7E-13),
        ];
...
/// Entropy part (internal helper)
///
/// Returns the part of the specific entropy which depends on salinity, temperature
/// and pressure, excluding the terms that are a function of salinity alone.
///
/// Arguments:
/// * `sa` – Absolute Salinity (g/kg), must be >= 0 and in the valid TEOS-10 range.
/// * `t`  – In-situ temperature (deg C, ITS-90 scale).
/// * `p`  – Sea pressure (dbar) (absolute pressure minus 10.1325 dbar).
///
/// Returns:
/// * Entropy contribution (J/(kg·K)) minus SA-only terms.
///
/// Reference:
            ...
            + x * (x
                * (y * (-137.114_501_840_898_2
                ...
                + y * (-86.132_935_195_608_4
                    + z * (766.116_132_004_952
                        + z * (-108.383_452_503_422_4 + 51.279_697_477_982_8 * z))
                    + y * (-30.068_211_258_562_5 - 1380.959_795_403_770_8 * z
                        + y * (3.502_402_647_235_78 + 938.260_750_445_42 * z))))
            + y * (1_760.062_705_994_408
                + y * (-675.802_947_790_203
                    + y * (365.704_179_100_503_6
                        + y * (-108.301_620_437_655_52 + 12.781_018_250_830_98 * y)
                        + z * (-1190.914_967_948_748
                            + (298.904_564_555_024 - 145.949_167_600_635_2 * z) * z))
                    + z * (2_082.734_442_399_804_3
                        + z * (-614.668_925_894_709
                            + (340.685_093_521_782 - 33.384_820_297_923_9 * z) * z)))
...
mod test_entropy_part {
    ...
    #[test]
    fn teos_10_reference_check() {
        assert!((entropy_part(0.0, 10.0, 100.0).unwrap() - 151.1355564471638).abs() < f64::EPSILON);
    }
}
