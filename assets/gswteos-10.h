...
void gsw_ct_first_derivatives_wrt_t_exact(double sa,
                                          double t,
                                          double p,
                                          double *ct_sa_wrt_t,
                                          double *ct_t_wrt_t,
...
void gsw_ct_freezing_first_derivatives(double sa,
                                       double p,
                                       double saturation_fraction,
                                       double *ctfreezing_sa,
                                       double *ctfreezing_p);

void gsw_ct_freezing_first_derivatives_poly(double sa,
                                            double p,
                                            double saturation_fraction,
                                            double *ctfreezing_sa,
                                            double *ctfreezing_p);
...
void gsw_ct_second_derivatives(double sa,
                               double pt,
                               double *ct_sa_sa,
                               double *ct_sa_pt,
                               double *ct_pt_pt);
...
void gsw_entropy_second_derivatives(double sa,
                                    double ct,
                                    double *eta_sa_sa,
                                    double *eta_sa_ct,
                                    double *eta_ct_ct);
...
void gsw_frazil_properties(double sa_bulk,
                           double h_bulk,
                           double p,
                           double *sa_final,
                           double *ct_final,
...
void gsw_frazil_properties_potential(double sa_bulk,
                                     double h_pot_bulk,
                                     double p,
                                     double *sa_final,
                                     double *ct_final,
...
void gsw_frazil_ratios_adiabatic(double sa,
                                 double p,
                                 double w_ih,
...
void gsw_frazil_ratios_adiabatic_poly(double sa,
                                      double p,
                                      double w_ih,
                                      double *dsa_dct_frazil,
                                      double *dsa_dp_frazil,
...
double *gsw_geo_strf_dyn_height(double *sa,
                                double *ct,
                                double *p,
                                double p_ref,
                                int n_levels,
...
int gsw_geo_strf_dyn_height_1(double *sa,
                              double *ct,
                              double *p,
                              double p_ref,
                              int n_levels,
...
double *gsw_geo_strf_dyn_height_pc(double *sa,
                                   double *ct,
                                   double *delta_p,
                                   int n_levels,
...
void gsw_ice_fraction_to_freeze_seawater(double sa,
                                         double ct,
                                         double p,
                                         double t_ih,
                                         double *sa_freeze,
...
void gsw_ipv_vs_fnsquared_ratio(double *sa,
                                double *ct,
                                double *p,
                                double p_ref,
                                int nz,
...
void gsw_linear_interp_sa_ct(double *sa,
                             double *ct,
                             double *p,
                             int np,
                             double *p_i,
...
void gsw_melting_ice_into_seawater(double sa,
                                   double ct,
                                   double p,
                                   double w_ih,
                                   double t_ih,
...
void gsw_melting_seaice_into_seawater(double sa,
                                      double ct,
                                      double p,
                                      double w_seaice,
                                      double sa_seaice,
...
double gsw_melting_seaice_sa_ct_ratio(double sa,
                                      double ct,
                                      double p,
                                      double sa_seaice,
                                      double t_seaice);

double gsw_melting_seaice_sa_ct_ratio_poly(double sa,
                                           double ct,
                                           double p,
                                           double sa_seaice,
                                           double t_seaice);

void gsw_nsquared(double *sa,
                  double *ct,
                  double *p,
                  double *lat,
                  int nz,
...
void gsw_pt_second_derivatives(double sa,
                               double ct,
                               double *pt_sa_sa,
                               double *pt_sa_ct,
                               double *pt_ct_ct);
...
void gsw_rho_first_derivatives_wrt_enthalpy(double sa,
                                            double ct,
                                            double p,
                                            double *rho_sa,
                                            double *rho_h);
...
void gsw_rho_second_derivatives(double sa,
                                double ct,
                                double p,
                                double *rho_sa_sa,
                                double *rho_sa_ct,
...
void gsw_rho_second_derivatives_wrt_enthalpy(double sa,
                                             double ct,
                                             double p,
                                             double *rho_sa_sa,
                                             double *rho_sa_h,
...
void gsw_rr68_interp_sa_ct(double *sa,
                           double *ct,
                           double *p,
                           int mp,
                           double *p_i,
...
void gsw_specvol_first_derivatives_wrt_enthalpy(double sa,
                                                double ct,
                                                double p,
                                                double *v_sa,
                                                double *v_h);
...
void gsw_specvol_second_derivatives(double sa,
                                    double ct,
                                    double p,
                                    double *v_sa_sa,
                                    double *v_sa_ct,
...
void gsw_turner_rsubrho(double *sa,
                        double *ct,
                        double *p,
                        int nz,
                        double *tu,
...
double *gsw_util_linear_interp(int nx,
                               double *x,
                               int ny,
                               double *y,
                               int nxi,
